...
<p class="card-address" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
    <a class="contact-link" href="<?php echo esc_url( $map_link ) ?>" target="_blank"><i class="material-icons u-align-top map-marker">&#xE55F;</i>
    ...
    <?php if( get_field('doc_website') ): ?>
        <p class="website-address" itemprop="url"><a class="contact-link" href="<?php the_field('doc_website'); ?>"><i class="u-align-middle material-icons">&#xE80B;</i> <?php the_field('doc_website'); ?></a></p>
    <?php endif; ?>
<?php
echo ob_get_clean();
endif;
...
<?php if( get_field('doc_phone_number') ): ?>
    <p class="phone" itemprop="telephone"><a class="contact-link" href="tel:<?php the_field('doc_phone_number'); ?>"><i class="u-align-middle material-icons">&#xE0CD;</i> <?php the_field('doc_phone_number'); ?></a></p>
<?php endif; ?>
...
<?php if( get_field('doc_email') ): ?>
    <p class="email" itemprop="email"><a class="contact-link" href="mailto:<?php the_field('doc_email'); ?>"><i class="u-align-middle material-icons">&#xE0BE;</i> <?php the_field('doc_email'); ?></a></p>
<?php endif; ?>
</div>
