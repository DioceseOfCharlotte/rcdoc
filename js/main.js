...
ready(function () {
  var glassTiles = document.querySelectorAll('.js-tile');
  ...
  try {
    for (var _iterator = glassTiles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
