...
(function() {
  ...
  Dropdown.prototype.clickHandler = function(event) {
      ...
      if( ! target.classList.contains(this.CssClasses_.DROPDOWN_IS_ACTIVE)){
        TweenLite.set(targetSibling, {height:"auto"});
        TweenLite.from(targetSibling, 0.2, {height:0});
        ...
        TweenLite.to(targetSibling, 0.2, {height:0});
