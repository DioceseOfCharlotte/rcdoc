...
<article <?php hybrid_attr('post'); ?>>
	...
	<header class="u-bg-1-dark u-flex u-flex-row u-flex-nowrap u-flex-justify-between u-br-t" style="<?php echo doc_prime_style(); ?> border-bottom: 5px solid <?php echo abe_second_hex() ?>;">
