			...
			<div class="employee-section u-bg-silver u-border u-m1 u-mb2 u-br">
				<div class="u-border-b u-flex u-flex-center u-p1">
					...
					<?php if ( current_user_can( 'upload_files' ) ) : ?>
						<a class="btn u-block u-opacity u-p1" href="<?php echo admin_url(); ?>" title="Dashboard"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em"><path d="M4 6c-1.105 0-2 .895-2 2v12c0 1.1.9 2 2 2h12c1.105 0 2-.895 2-2H4V6zm16-4H8c-1.105 0-2 .895-2 2v12c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V4c0-1.105-.895-2-2-2zm-5 14H8V9h7v7zm5 0h-3V9h3v7zm0-9H8V4h12v3z"/></svg></a>
					<?php endif; ?>
