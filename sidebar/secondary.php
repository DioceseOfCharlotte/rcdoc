...
<aside class="js-off-canvas off-canvas u-fix u-left0 u-top0 u-1of1 u-height100 if-admin-bar u-overflow-hidden">
    ...
    <div class="off-canvas__content u-py2 u-flexed-1 ">
		...
		<?php $current_user = wp_get_current_user(); ?>
			<div class="employee-section u-border u-m1 u-mb2 u-br">
				<div class="u-border-b u-h4 u-text-1-dark u-text-display u-text-center u-mb1 u-p1">
					<?php echo '<em class="u-f-plus u-text-grey">Logged in as: </em>' . $current_user->display_name ?>
				</div>
